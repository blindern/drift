...
$config = [
  ...
  "store.type" => "sql",
  "store.sql.dsn" => "pgsql:host=postgresql-1.zt.foreningenbs.no;dbname=simplesamlphp",
  "store.sql.username" => "simplesamlphp",
  "store.sql.password" => $simplesamlphp_pg_password,
